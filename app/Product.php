...
class Product extends Model implements Buyable 
{
    ...
    protected $casts =  ['available_areas' => 'array', 'delivery_areas' => 'array', 'services' => 'array'];
    ...
    public function getImgPathAttribute()
    {
        ...
        return asset('storage/main/products/'. $this->image);
    }

    public function getThePriceAttribute()
    {
        return $this->sort == null ? $this->price.' '.Settings::findOrFail(1)->currency : $this->price.' '.Settings::findOrFail(1)->currency.' / '.$this->sort;
    }
    ...
    public function getOtherImagesPathAttribute()
    {
        ...
        if($this->other_images !== null){
            ...
            {
                //$other_image = url('storage/app/public/main/other_images/products/'. $other_image);
                $other_image = url('storage/main/other_images/'.$this->name.'/'. $other_image);
