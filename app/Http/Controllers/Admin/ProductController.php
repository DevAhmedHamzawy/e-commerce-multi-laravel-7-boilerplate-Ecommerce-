...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.products.add', compact('options', 'categories', 'areas'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        return view('admin.products.edit', compact('options', 'categories', 'product', 'theCategory', 'theSubCategory', 'selectedOptions','areas'));
    }
