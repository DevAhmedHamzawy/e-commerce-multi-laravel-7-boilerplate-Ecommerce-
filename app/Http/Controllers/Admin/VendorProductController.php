...
class VendorProductController extends Controller
{
    ...
    */
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(ProductFormRequest $request, Admin $vendor)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(ProductFormRequest $request, Admin $vendor, Product $the_vendor_product)
    {
        $product = $the_vendor_product;
