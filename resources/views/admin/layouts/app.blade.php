@php
    ...
    {
      if(\Request::route()->getName() !== 'vendor_verify'){
        header("Location: " . URL::to('vendor/vendor_verify'), true, 302);
        exit();
      }
    }
@endphp
...
<head>
    ...
    <title>{{-- $settings->name --}} - الرئيسية</title>
    @yield('header')
</head>
<body>
  <nav class="navbar navbar-expand-lg fixed-top">

    <a class="navbar-brand" href="#"><img src="{{ asset('admin/panel/img/logo.png') }}" width="130" height="100%" style="margin-right: 0.9em;" /></a>
        ...
        <div class="sideMenu bg-mattBlackLight" style="font-size: 18px;">
            <div class="sidebar">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item"><a href="{{ url('admin/dashboard') }}" class="nav-link px-2"><i class="material-icons icon">dashboard</i><span class="text">الرئيسية </span></a></li>


                  @if (auth()->user()->role == 0)


                  <li class="nav-item"><a href="{{ url('admin/admins') }}" class="nav-link px-2"><span class="text text-white"> <i class="material-icons icon">assignment_ind</i> مديرين المنصة </span></a></li>
                  <li class="nav-item"><a href="{{ url('admin/the_vendors') }}" class="nav-link px-2"><i class="material-icons icon">assignment_ind</i><span class="text text-white"> الأعضاء </span></a></li>
                  <li class="nav-item"><a href="{{ url('admin/users') }}" class="nav-link px-2"><span class="text text-white"> <i class="material-icons icon">assignment_ind</i> الضيوف </span></a></li>

                  <li class="nav-item"><a href="{{ url('admin/producers_categories') }}" class="nav-link px-2"><span class="text text-white"> <i class="material-icons icon">category</i> أقسام المنتجين</span></a></li>
                  <li class="nav-item"><a href="{{ url('admin/stores_categories') }}" class="nav-link px-2"><span class="text text-white"> <i class="material-icons icon">category</i> أقسام المتاجر</span></a></li>
               

                  <li class="nav-item"> 
                    <a href="#" data-toggle="collapse" data-target="#d" class="nav-link px-2 collapsed " > <i class="material-icons icon">web</i> <span class="text"> المنتجات   </span> <span class="the_arrow fa fa-chevron-left text-light"></span> </a>
                    <ul class="sub-menu collapse" id="d"  >
                      <li class="nav-item"><a href="{{ url('admin/categories') }}" class="nav-link px-2"><span class="text text-white"> >> أقسام المنتجات</span></a></li>
                  ...
                  <li class="nav-item"> 
                   ...
                   <li class="nav-item"><a href="{{ url('admin/pages') }}" class="nav-link px-2"><span class="text text-white"> <i class="material-icons icon">category</i> معلومات </span></a></li>  

                   <li class="nav-item"><a href="{{ url('admin/partners') }}" class="nav-link px-2"><span class="text text-white"> <i class="material-icons icon">category</i> الشركاء </span></a></li>

                   <li class="nav-item"><a href="{{ url('admin/places') }}" class="nav-link px-2"><span class="text text-white"> <i class="material-icons icon">category</i> المناطق والمدن </span></a></li>  

                   <li class="nav-item"><a href="{{ url('admin/a_product_messages') }}" class="nav-link px-2"><i class="material-icons icon">settings</i><span class="text">الرسائل</span></a></li>

                    <li class="nav-item"><a href="{{ url('admin/settings') }}" class="nav-link px-2"><i class="material-icons icon">settings</i><span class="text">إعدادات المنصة</span></a></li>
                  ...
                  <li class="nav-item"><a href="{{ url('vendor/v_returnings') }}" class="nav-link px-2"><i class="material-icons icon">collections</i><span class="text">الطلبات المعادة</span></a></li>

                 
                  <li class="nav-item"><a href="{{ url('vendor/v_settings/'.auth()->user()->user_name.'') }}" class="nav-link px-2"><i class="material-icons icon">collections</i><span class="text">إعدادات متجرى</span></a></li>

             
                  <li class="nav-item"><a href="{{ url('vendor/v_product_messages') }}" class="nav-link px-2"><i class="material-icons icon">collections</i><span class="text">الرسائل</span></a></li>

                  <li class="nav-item"><a href="{{ url('vendor/services') }}" class="nav-link px-2"><i class="material-icons icon">settings</i><span class="text">الخدمات</span></a></li>
