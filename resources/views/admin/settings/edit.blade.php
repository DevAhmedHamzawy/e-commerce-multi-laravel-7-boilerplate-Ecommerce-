...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header"> <h5 class="text-center">إسم المنصة</h5> </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('settings.update', $settings->id) }}">
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-2 col-form-label text-md-right">إسم المنصة</label>
                ...
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('settings.update', $settings->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="the_first_image" type="file" class="form-control @error('the_first_image') is-invalid @enderror" name="the_first_image" autocomplete="the_first_image">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="the_second_image" type="file" class="form-control @error('the_second_image') is-invalid @enderror" name="the_second_image" autocomplete="the_second_image">
                ...
                <div class="card">
                    <div class="card-header"><h5 class="text-center">عن المنصة وبيانات التواصل الإجتماعى</h5></div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('settings.update', $settings->id) }}">
                            ...
                            <div class="form-group row">
                                <label for="about" class="col-md-2 col-form-label text-md-right">عن المنصة</label>
                            ...
                            <div class="form-group row mb-0">
                                <button type="submit" class="btn btn-primary col-md-12">
                                    تعديل بيانات عن المنصة وبيانات مواقع التواصل الإجتماعى
                                </button>
                            </div>
                        </form>
                    </div>
