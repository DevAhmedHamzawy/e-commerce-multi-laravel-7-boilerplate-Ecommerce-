                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('products.update', $product->slug) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="checkbox" name="groups" checked="1" @if($product->groups == 1) checked  @endif>
                                <label>المجموعات</label>
                               
                                &nbsp;&nbsp;&nbsp;&nbsp;
        
                                <input type="checkbox" name="offers" checked="1" @if($product->offers == 1) checked  @endif>
                                <label>العروض</label>
        
                                &nbsp;&nbsp;&nbsp;&nbsp;
        
                                <input type="checkbox" name="distributions" checked="1" @if($product->distributions == 1) checked  @endif>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="discount" type="text" class="form-control @error('discount') is-invalid @enderror" name="discount" value="{{ $product->discount }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="shipping" id="inlineRadio1" value="1" @if($product->shipping == 1) checked @endif>
                                    <label class="form-check-label" for="inlineRadio1">نعم</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="shipping" id="inlineRadio2" value="0" @if($product->shipping == 0) checked @endif>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="packing" id="inlineRadio1" value="1" @if($product->packing == 1) checked @endif>
                                    <label class="form-check-label" for="inlineRadio1">نعم</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="packing" id="inlineRadio2" value="0" @if($product->packing == 0) checked @endif>
                                    <label class="form-check-label" for="inlineRadio2">لا</label>
                                </div>
