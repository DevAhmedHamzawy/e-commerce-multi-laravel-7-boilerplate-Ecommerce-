...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <h2 class="card-header text-center">التعديل على القسم {{ $category->name }}</h2>

                <div class="card-body">
                    <form method="POST" action="{{ route('producers_categories.update' , $category->slug) }}"  enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
