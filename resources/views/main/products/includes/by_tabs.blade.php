          ...
          <div class="tab-pane fade active show" id="breakfastone" role="tabpanel" aria-labelledby="breakfast-one-tab">
            @foreach ($products as $product)
              <div class="row" style="padding-bottom: 25px;">
                <div class="col-md-4 text-center"><a href="{{ route('all_products.show', $product->slug) }}" class="namename"><img src="{{ $product->img_path}}" class="pro_image" alt="" srcset=""></a></div>
                  <div class="col-md-6">
                    <h4><a href="{{ route('all_products.show', $product->slug) }}" class="namename">{{ $product->name }}</a></h4><span class="trade"> {!! $product->brief_description !!}</span>
                  </div>
            ...
            @foreach ($products as $product)
              <div class="row" style="padding-bottom: 25px;">
                <div class="col-md-4 text-center">
                  <a href="{{ route('all_products.show', $product->slug) }}" class="namename"><img src="{{ $product->img_path}}" class="pro_image" alt="" srcset=""></a>
                
                </div>
                  <div class="col-md-6">
                    <h4 class="namename">{{ $product->name }} </h4>
                    <span class="trade">
