            ...
            <div class="col-md-6">
              @foreach ($specialProducts as $product)
                <div class="single_menu_list row" style="border-left: solid 1px black;">
                  <a href="{{ route('all_products.show', $product->slug) }}"  class="col-md-6"><img src="{{ $product->img_path }}" width="100%" alt="" srcset=""></a>
                  <div class="col-md-6">
                    <h4>{!! $product->description_ar !!}</h4>
                    <p><a href="{{ route('all_products.show', $product->slug) }}" style="text-decoration: none;color: #ffffff;">{{ $product->{'name_' . $locale} }}</a></p>
            ...
            <div class="owl-carousel owl-theme">
              @foreach ($products as $product)
                <div class="item">
                  ...
                  <a href="{{ route('all_products.show', $product->slug) }}"> <div> <img src="{{ $product->img_path}}"  alt="" srcset=""> </div> </a>
