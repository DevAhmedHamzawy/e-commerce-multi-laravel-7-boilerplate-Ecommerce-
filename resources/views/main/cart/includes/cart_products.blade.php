     ...
     <div class="pro_cart">
        <div class="row" style="margin-right: 0;">
            <div class="col-md-4 image">
                <a href="{{ route('all_products.show', $item->model->slug) }}"><img src="{{ $item->model->img_path }}" class="img-fluid" alt=""></a>
            </div>
            
            <div class="col-md-8 image_data">
                    <a href="{{ route('all_products.show', $item->model->slug) }}" style="text-decoration: none;"><h4>{{ $item->model->name }}</h4></a>
