        ...
        <div class="sideMenu bg-mattBlackLight" style="font-size: 18px;">
            <div class="sidebar">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item"> 
                    <a href="#" data-toggle="collapse" data-target="#d" class="nav-link px-2 collapsed " > <i class="material-icons icon">web</i> <span class="text"> واجهة المنصة  </span> <span class="the_arrow fa fa-chevron-left text-light"></span> </a>
                  ...
                  <li class="nav-item"> 
                    <a href="#" data-toggle="collapse" data-target="#d_two" class="nav-link px-2 collapsed " > <i class="material-icons icon">person</i> <span class="text"> الضيوف  </span> <span class="the_arrow fa fa-chevron-left text-light"></span> </a>
                    <ul class="sub-menu collapse" id="d_two"  >
                      <li class="nav-item"><a href="{{ url('admin/users') }}" class="nav-link px-2"><span class="text text-white"> >> الضيوف </span></a></li>
                      {{--<li class="nav-item"><a href="#" class="nav-link px-2"><i class="material-icons icon">collections</i><span class="text">مجموعات الضيوف</span></a></li>
                      ...
                      <li class="nav-item"><a href="#" class="nav-link px-2"><i class="material-icons icon">collections</i><span class="text">خانات الضيوف</span></a></li>--}}
                    </ul>
                  </li>
                    ...
                    <li class="nav-item"> 
                      ...
                      <ul class="sub-menu collapse" id="d_three"  >
                        <li class="nav-item"><a href="{{ url('admin/users') }}" class="nav-link px-2"><span class="text text-white"> >> الضيوف </span></a></li>
                        <li class="nav-item"><a href="{{ url('admin/admins') }}" class="nav-link px-2"><span class="text text-white"> >> مديرين المنصة </span></a></li>
                        <li class="nav-item"><a href="{{ url('admin/the_vendors') }}" class="nav-link px-2"><span class="text text-white"> >> الأعضاء </span></a></li>
                      </ul>
                    </li>
                  ...
                  <li class="nav-item"><a href="{{ url('vendor/v_settings/'.auth()->user()->user_name.'') }}" class="nav-link px-2"><i class="material-icons icon">collections</i><span class="text">إعدادات العضو</span></a></li>
